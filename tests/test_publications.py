...
#       "Bibliographic Reference":"Gerstenberger MC, Van Houtte C, Abbott ER, Van Dissen RJ, Kaiser\u00a0AE, Bradley B, Nicol A, Rhoades DA, Stirling MW, Thingbaijam\u00a0KKS, NSHM Team. 2020. New Zealand National Seismic Hazard Model framework plan. Lower Hutt (NZ): GNS\u00a0Science. 25\u00a0p. (GNS Science report; 2020\/38). doi:10.21420\/NB8W-GA79.",  # noqa
...
class TestDisaggsWithS3(unittest.TestCase):
    ...
    def test_s3_create_publications(self):
        ...
        obj = json.load(file_object)['data']
        self.assertEqual(len(obj), 34)
